...
public class Camera extends AppCompatActivity {
    ...
    public native void imageprocessing1(long inputImage, long outputImage, int th1, int th2); //두통
    public native void imageprocessing2(long inputImage, long outputImage, int th1, int th2); //복통
    public native void imageprocessing3(long inputImage, long outputImage, int th1, int th2); // 생리통
    public native void imageprocessing4(long inputImage, long outputImage, int th1, int th2); // 요통
